		...
		<div class="right_page">
			...
			<div class="button">
				<c:if test="${clubMaster == 1}">
					<button onClick="location.href='createNotice'" class="btn_notice2">글쓰기</button>
				</c:if>
			</div>
			<br> <br>
			<div class="board_common01 notice">
				<ul style="padding-inline-start: 0px;" id="noticeList"> </ul>
				...
				<li>
					...
					<dl style="margin-block-start: 0em; margin-block-end: 0em;">
						<dt>
							<a class="m_title" href="cnRead?cn_no={{cn_no}}">{{cn_title}}</a> 
						</dt>
					</dl>
                    <p class="info_r2">
						<span>관리자</span>
