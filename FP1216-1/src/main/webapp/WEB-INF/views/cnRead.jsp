	...
	<div class="all_page4">
		...
		<div class="right_page2">
	   	...
	   	<div class="head-title">
			...
			<c:if test="${cnvo.cn_bold=='1'}"><h5 class="head-title-username">중요공지사항</h5></c:if>&nbsp&nbsp&nbsp&nbsp
			<c:if test="${cnvo.cn_rchk=='1'}"><h5 class="head-title-username">댓글 허용 게시물</h5></c:if>
		</div>
