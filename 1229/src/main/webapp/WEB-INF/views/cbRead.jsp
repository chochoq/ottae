	...
	<div class="all_page4">
		...
		<div class="right_page2">
	   	...
	   	<div class="head-title">
			<textarea class="head-title-title" readonly>${cbvo.cb_title}</textarea>
			<h5 class="head-title-username">${cbvo.id}</h5>
			<h5 class="head-title-date"><fmt:formatDate  value="${cbvo.cb_regdate}" pattern="yyyy-MM-dd HH:mm:ss"/></h5>
		</div>
		<div class="right_page2-cot">
			<textarea class="right_page2-cot-cot" readonly>${cbvo.cb_content}</textarea>
		</div>
