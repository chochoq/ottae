package com.example.controller.customerService;
...
public class NoticeController {
    ...
    public String notice_read(int n_no, Model model, HttpSession session) {
        ...
        if (nvo.getId().equals((String) session.getAttribute("id"))) {
            return "customerService/notice_update";
        }
        return "customerService/notice_read";
    }
    ...
    public String createMasterNotice(HttpSession session) {
        ...
        if (id == null) {
            ...
            if (id.equals("master")) {
                return "customerService/createMasterNotice";
            } else {
