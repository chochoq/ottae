...
<body>
   ...
   <div class="logoTop"><a>로고 넣을곳</a></div>
      ...
      <div class="mainPage">   
               ...
               <h3 class="join_title">
                  <label>비밀번호</label>
               		...
               		<span class="ps_box int_id">
                    	<input type="password" id="checkaa" name="pw"  maxlength="20" oninput="checkPwd()" required class="int">
                    </span>
            ...
            <div>
                <h3 class="join_title">
              	...
              	<div>
	               	<textarea rows="3" cols="30" name="u_keyword" required class="int2" oninput="checkId()" style="height:150px; width:500px; resize: none; font-size: 20px; ">
	               	</textarea>
               	</div>
            </div>
      </div>
