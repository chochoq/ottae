				...
				<tbody>
					...
					<tr class="cafe_keyword">
						...
						<td>
							<div class="SectionCreateCafeKeyword">							
								<div class="cafe_keyword_input_area">
									<div class="FormInputText">
										<input type="text"class="input_text input_txt2" name="c_condition">
									</div>																
								</div>
							</div>						
					    </td>
					...
					<tr class="cafe_keyword">
						...
						<td>
							<div class="SectionCreateCafeKeyword">							
								<div class="cafe_keyword_input_area">
									<div class="FormInputText">
										<input type="text"class="input_text input_txt2" name="c_spot">
									</div>																								
								</div>
							</div>
					...
					<tr>
	                   	...
	                   	<td width=500>
	                     	...
	                     	<input type="file" name="c_pic" class="imgSel">
	                    </td>
					</tr>					
				</tbody>
			</table>
