				...
				<ul style="padding-inline-start: 0px;">
					...
					<li>
						...
						<dl style="margin-block-start: 0em; margin-block-end: 0em;">
							<dt>
								<a class="m_title" href="cnRead?cn_no=${vo.cn_no}">${vo.cn_title}</a> <span class="namecl">관리자</span>
							</dt>
						</dl>
						<p class="info_r">
	...
	if(clubMaster == 1){
		...
		$.ajax({
			...
			success:function(data){
				...
				var str="";
				if(chk== 0){
					str = "<input type='button' value='가입신청' id='btnJoinClub' class='clupJoin' onClick=location.href='club_join'>"	
				}else if(chk==1){
					str = "승인 대기중인 계정입니다."	
				}else{
					$("#btnJoin").hide(); // Hide
